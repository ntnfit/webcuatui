<section class="py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="relative p-px rounded-2xl overflow-hidden bg-white dark:bg-gray-900">
            <!-- Animated gradient border -->
            <div class="absolute inset-0">
                <div class="absolute inset-0 bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 animate-border-flow"></div>
            </div>
            ...
            <div class="relative bg-white dark:bg-gray-900 rounded-2xl p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($latestArticles as $article)
                        <div class="relative group animate-fade-in-up" style="animation-delay: {{ $loop->index * 100 }}ms">
                            <!-- Hover -->
                            <div class="absolute inset-0 bg-linear-to-r from-blue-300 via-purple-300 to-pink-300 dark:bg-linear-to-r dark:from-blue-500 dark:via-purple-500 dark:to-pink-500 animate-border-flow rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:translate-x-[-6px] group-hover:translate-y-[-6px] relative z-10 h-full flex flex-col">
                                <a href="{{ route('blogs.show', $article['id']) }}" class="block relative h-48 overflow-hidden shrink-0">
                                    <div class="absolute inset-0 bg-linear-to-b from-transparent to-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"></div>
                                ...
                                <div class="p-6 flex flex-col grow">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <div class="flex items-center text-yellow-500 shrink-0 ml-2">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2 grow">
                                        {{ $article['excerpt'] }}
                                    </p>
                ...
                <div class="mt-12 text-center animate-fade-in-up">
                    <a href="{{ route('blogs.index') }}" class="inline-flex items-center px-6 py-3 rounded-full bg-linear-to-r from-sky-500 to-indigo-500 dark:from-purple-500 dark:to-pink-500 text-white hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-300 font-semibold transform hover:scale-105">
                        Xem tất cả bài viết
