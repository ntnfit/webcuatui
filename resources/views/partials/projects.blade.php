        ...
        <div class="relative animate-fade-in">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12 items-center overflow-hidden">
                @foreach([
                    ...
                    ['id' => '10', 'name' => 'Nissey', 'logo' => 'https://www.nihon-s.co.jp/wp-content/uploads/elementor/thumbs/logo001-poowskldjo65xxcjfqkcvjrcq33ci0zr2933ho3v3g.png', 'link' => 'http://www.nihon-s.co.jp/group-company/nissey-vietnam/', 'description' => 'Nissey is a leading manufacturer of high-quality pharmaceutical products in Vietnam.'],
