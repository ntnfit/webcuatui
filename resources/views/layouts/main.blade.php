...
<body class="font-sans antialiased min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500">
    ...
    <!-- Theme Toggle Button -->
    <button id="theme-toggle" aria-label="Toggle theme" class="fixed top-4 right-4 p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300 z-50">
