        ...
        <div x-ref="speedometer" class="relative min-[630px]:grid">
            ...
            <div x-ref="speedometer_circle"
                ...
                <div class="tall-link-wrapper group/tall-link absolute -right-36 -top-16 z-20">
                    <a href="https://tailwindcss.com" target="_blank"
                        ...
                        {{-- Logo --}}
                        <svg class="w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33">
                    ...
                    <a href="https://alpinejs.dev" target="_blank"
                        ...
                        <svg class="scale-90" width="32" height="16" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="m24.657.653 7.045 7.066-7.045 7.066-7.044-7.066L24.657.653Z" fill="#77C1D2" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="m7.045.653 14.605 14.65H7.56L0 7.718 7.045.653Z" fill="#2D3441" />
                        </svg>
                        {{-- Title --}}
                ...
                <svg x-ref="fade_arc" width="28" class="absolute -top-[3.2rem] right-[7.2rem] -rotate-[92deg]"
                    ...
                    <defs>
                        <linearGradient id="a" x1="4" y1="129.5" x2="-51.33" y2="73.589"
                            ...
                            <stop offset="1" stop-color="#F1E3E3" stop-opacity="0" />
                        </linearGradient>
                    </defs>
                </svg>
                {{-- Speed Lines --}}
                <svg x-ref="speed_lines" class="absolute -right-16 -top-16 w-72 rotate-2" width="311"
                    ...
                    <path d="M90.426 19.2023V1.55276" stroke="#F1E3E3" stroke-width="2" stroke-linecap="round" />
                    ...
                    <path d="M190.44 47.4417L199.853 32.1454" stroke="#FF7323" stroke-width="2"
                        stroke-linecap="round" />
                    <path d="M204.129 57.0277L208.582 49.9995" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M219.497 66.5752L224.295 60.3074" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M231.622 79.2213L236.872 73.3276" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M243.389 91.6934L249.272 86.2707" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M253.979 104.98L259.915 100.39" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M264.569 120.393L278.688 112.157" stroke="#FF7323" stroke-width="2"
                        stroke-linecap="round" />
                    <path d="M270.978 134.731L278.559 131.303" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M278.576 151.15L286.028 148.548" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M283.394 168.323L291.019 166.282" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M286.924 185.232L294.819 183.932" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M289.278 203.333L296.76 202.758" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M290.454 220.407L309.281 220.407" stroke="#FF7323" stroke-width="2"
                        stroke-linecap="round" />
                    <path d="M289.277 238.057L297.578 238.62" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M287.481 255.814L295.278 257.043" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M283.611 272.049L291.295 273.854" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M278.73 288.618L286.302 291.204" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M272.249 304.505L279.114 307.535" stroke="#FF7323" stroke-linecap="round" />
                    <path d="M264.569 321.598L279.865 331.011" stroke="#FF7323" stroke-width="2"
                        stroke-linecap="round" />
                </svg>
            </div>
            {{-- TALL Stack --}}
            <div
                ...
                <div x-ref="tall_stack_description"
                    ...
                    <div class="pt-5 text-center text-xs text-dolphin min-[600px]:text-left min-[700px]:text-right">
                        /tɔːl stæk/
                    </div>
                    <div class="pt-5 text-center text-dolphin min-[600px]:text-left min-[700px]:text-right">
            ...
            <div x-ref="orange_speed_decoration"
                class="relative top-10 hidden self-start justify-self-start [grid-area:1/-1] min-[700px]:block md:-top-32 md:self-end">
                <svg width="129" height="102" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="27" y="26.161" width="80" height="80" rx="20"
                        transform="rotate(-19 27 26.161)" fill="#FFF0E8" />
                    <path d="M2 38h76M55 51.115h33" stroke="#FFD1BB" stroke-width="3" stroke-linecap="round" />
                </svg>
            </div>
            {{-- Gray Speed Decoration --}}
            <div x-ref="gray_speed_decoration"
                class="relative hidden self-end justify-self-end [grid-area:1/-1] min-[700px]:block md:-top-10">
                <svg width="105" height="102" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="3" y="26.161" width="80" height="80" rx="20"
                        transform="rotate(-19 3 26.161)" fill="#FAF4F4" />
                    <path d="M2 59.115h60M44 72.115h27" stroke="#E6D1D1" stroke-width="3" stroke-linecap="round" />
                </svg>
            </div>
            {{-- Stats --}}
            <div
