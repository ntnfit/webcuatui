<div x-cloak x-data="{}" class="mx-auto w-full max-w-(--breakpoint-lg) px-10 pt-40 lg:px-5">
    <div x-data="{}" x-init="() => {
        ...
        <div x-ref="header">
            ...
            {{-- Description --}}
            <div class="min-w-[18rem] max-w-88 pt-7 font-medium text-dolphin dark:text-white">
        ...
        <div x-ref="mockup" class="group/mockup relative grid w-full max-w-lg">
            {{-- Mockup --}}
            <div
                class="w-[95%] self-center justify-self-center overflow-hidden rounded-bl-xl rounded-br-xl rounded-tl-lg rounded-tr-lg shadow-lg shadow-black/5 transition-all duration-1000 [grid-area:1/-1] transform-3d group-hover/mockup:transform-[perspective(1500px)_rotateY(0deg)_rotateX(0deg)_translateZ(0)] motion-reduce:transition-none motion-reduce:group-hover/mockup:transform-none md:transform-[perspective(1500px)_rotateY(-10deg)_rotateX(5deg)_translateZ(0)]">
                {{-- Window Header --}}
            ...
            <div
                class="relative -z-10 h-[120%] w-full self-center justify-self-center rounded-[3rem] bg-linear-to-br from-dawn-pink to-transparent [grid-area:1/-1] md:left-10 md:rotate-2 md:justify-self-start lg:h-100 lg:w-[110%]">
            </div>
        </div>
    </div>
</div>
