<div x-cloak x-data="{}" class="mx-auto w-full max-w-screen-lg pt-60">
    <div x-data="{}" x-ref="sunset_section" x-init="() => {
        ...
        <div class="mx-auto grid w-full max-w-4xl">
            ...
            {{-- Sun Blur --}}
            <div class="relative top-14 z-20 self-end justify-self-center [grid-area:1/-1]">
                <div class="h-28 w-60 bg-cream/10 backdrop-blur-md sm:h-32"></div>
            </div>
        ...
        {{-- Takeoff --}}
        <div x-ref="take_off" class="px-4 pt-3 text-3xl font-extrabold">
            Ready to take off?
        </div>
        ...
        {{-- Get Started Link --}}
        <div x-ref="getstarted" class="px-4 pt-10">
            <a href="#"
                ...
                <div class="pr-4">
                    <svg width="24" height="24"
                        ...
                        <path d="M4 12.992h2.5m13.5 0-6-6m6 6-6 6m6-6H9.5" stroke="currentColor" stroke-width="1"
