        ...
        <div className="space-y-8">
            {skillGroups.map((group, index) => (
                ...
                >
                    ...
                    {/* Content container */}
                    <div className="relative bg-white/5 dark:bg-gray-900/70 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/50 dark:hover:bg-gray-800/50 transition-all duration-300 shadow-sm">
